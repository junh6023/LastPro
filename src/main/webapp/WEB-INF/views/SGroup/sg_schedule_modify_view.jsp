...
<form action="sg_schedule_modifyaction?u_id=test15" method="post">
<table>
<tr>
<td>일정 :</td>
<td>
	...
	<input type="hidden" name="sgs_id" value="${list.sgs_id}">
</td>
</tr>
<tr>
<td>제목 :</td><td><input type="text" name="sgs_title" value="${list.sgs_title}"></td>
</tr>
<tr>
