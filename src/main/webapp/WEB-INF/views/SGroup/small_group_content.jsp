				...
				<div class="main-text" >
					<c:forEach items="${content}" var="content">
						<table  border="1" align="center">
							<tr>
								<td>번호</td><td>${content.sg_id}</td>
							</tr>
							<tr>
								<td>동아리 명</td><td>${content.sg_name}</td>
							</tr>
							<tr>
								<td>소개</td><td>${content.sg_intro}</td>
							</tr>
						</table>
						<a href="small_group_join?sg_id=${content.sg_id}&sg_name=${content.sg_name}&u_id=test11">가입하기</a><!-- 로그인된 유저아이디 ${u_id}해야됨  -->
					</c:forEach>
				</div>
			</div>
