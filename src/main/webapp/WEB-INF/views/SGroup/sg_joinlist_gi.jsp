	...
	<jsp:include page="../top.jsp" />
			<div class="conteant" >
				...
				<!-- 모임장일때만 볼수있는 페이지가 되어야됨
					select u_id from small_group_list 로 모임장들의 아이디를 뽑은 다음
					...
					<table  border="1" align="center">
						...
						<tr>
							<td>${joinlist.u_id}</td>
							<td>${joinlist.sgj_date}</td>
							<td>${joinlist.y_n}</td>
							<td>${joinlist.note}</td>
							<td><a href="sg_yes?u_id=${joinlist.u_id}&sg_id=${joinlist.sg_id}&sgj_id=${joinlist.sgj_id}">승인</a></td>
							<td><a href="sg_no?sgj_id=${joinlist.sgj_id}">거절</a></td>
						</tr>
						</c:forEach>
